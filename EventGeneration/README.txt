...
Also depending whether you want to simulate the signal or the background you need to (un)commnet the appropiate lines of code in the main202.cc and the plot.cxx files.
Then you can do:
